***
     ...
     &                  epoch,tm,tphys,tphysf,dtp,z,zpars,dtmnew)
c-------------------------------------------------------------c
c
...
c make sse && ( ar -r libsse_mportal.a *.o && (gcc -o sse_ bhi_sse.c  -L . -L /opt/SUNWhpc/lib  -lgfortran -lsse_mportal -lm && sse_ 42.3|tail -3))
...
*
      ...
      INTEGER bhflag,ceflag,tflag,ifflag,nsflag,wdflag
